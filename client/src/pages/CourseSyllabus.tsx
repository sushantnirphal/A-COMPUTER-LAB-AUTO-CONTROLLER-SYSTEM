  ...
  return (
    <main className="h-screen w-full gr-bg">
      ...
      <section className="w-full pt-28 p-8 text-white md:w-1/2 min-h-full border-l">
        <h1 className="text-lg font-semibold text-gr bg-clip-text text-transparent font-semibold lg:text-2xl">
          ...
          <main className="py-8 space-y-6">
            {syllabus.map(
              (item: {
                ...
                <div
                  key={item._id}
                  className="flex text-slate-800 items-center border bg-blue/30 bg-transparent px-6 py-2 rounded"
                >
                  <h4 className="text-lg w-9/12 font-semibold text-white">
                    {item.subject}
                  </h4>
